...
int main( int argc, char *argv[])
{
  ...
  gtk_container_add(GTK_CONTAINER (pinfo->frame1),pinfo->movebox);
  ...
  pinfo->adj[4] = (GtkAdjustment *) gtk_adjustment_new (1.3, 1.2, 1.5, 0.001, 1.0, 0); 
  ...
  pinfo->adj[2] = (GtkAdjustment *) gtk_adjustment_new (100, 0.0, 500, 0.001, 1.0, 0); 
